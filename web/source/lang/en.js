module.exports =  {
  ...
  HomeWhatDesMobile2: 'Design-build is a method of project delivery in which one entity - the design-build team - works under a single contract with the project owner.',
  ContactText: 'If you have any ideas to elevate your working space, please let AVT turn them into reality!',
  ContactHead1: 'Thank you for trusting AVT.',
  ContactHead2: 'Let AVT turn your ideas into reality!',
  SEEMORE: 'SEE MORE',
  Latestby2021: 'Latest by 2021',
  HeadOffice: 'Head Office',
  Branch: 'Branch',
  Pleaseselecttypeofenquiry: 'Type of enquiry',
  MailUs: 'Mail Us',
  Subject: 'Subject*',
  Title: 'Title',
  Fistname: 'Fist name',
  ...
  Wherewework: 'Where we work ?',
  WherePlaceName1: 'Ho Chi Minh (Electrolux Office)',
  ...
  WherePlaceName9: 'Binh Duong (Koi Thé)',
  WherePlaceDes9: 'One of Koi’s most remarkable stores in Vietnam, where 3D models are brought entirely to the real world.',
  WherePlaceName10: 'Binh Duong (Koi Thé)',
  WherePlaceDes10: 'One of Koi’s most remarkable stores in Vietnam, where 3D models are brought entirely to the real world.',
  OurNetwork: 'Our Network',
  ...
  PMPEfficency: 'AECIS (Efficiency)',
  WhereUniquenessDes2: 'AECIS provides project management solutions for construction industry.',
  WhereUniquenessDes3: 'As of the moment, AVT is utilizing AECIS in all current projects.',
  Issue: 'Issue',
  Submittal: 'Submittal',
  Milestone: 'Milestone',
  DMAP: 'DMAP',
  ...
  Address1: 'Level 9, Doxaca Building, 307B Nguyen Van Troi Str., W1, Tan Binh Dist, HCMC',
  HaNoi: 'Ha Noi',
  Address2: 'Level 5, Sentinel Place, 41A Ly Thai To Str., Hoan Kiem Dist, Ha Noi',
  DaNang: 'Da Nang',
  Address3: '267 Tran Phu Str., Hai Chau Dist, Da Nang City',
  ...
  WhoSubTitle1: 'Efficiency',
  WhoSubTitle2: 'Aesthetic',
  WhoSubTitle3: 'Trust, Honesty, Boldness, Innovation, Commitment.',
  WhoSubDes1: 'Competency value',
  WhoSubDes2: 'Service value',
  ...
  LeadDes2: 'In Vietnam, AVT has provided creative solutions for big clients, namely AEON, Toshin Development, Phu My Hung, CJ Group.',
